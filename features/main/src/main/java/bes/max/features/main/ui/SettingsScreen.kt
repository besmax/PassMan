...
fun SettingsScreen(
    ...
    val imageVector: ImageVector = ImageVector.vectorResource(R.drawable.icon_background)
    ...
    Column(
        modifier = Modifier
            ...
            .drawWithContent {
                with(vectorPainter) {
                    val size = this@drawWithContent.size.copy(
                        width = this@drawWithContent.size.width * 1.1f,
                        height = this@drawWithContent.size.height * 1.1f
                    )
                    this@drawWithContent.draw(size = size)
                }
